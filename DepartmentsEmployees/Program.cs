    ...
    class Program
    {
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            employees.ForEach(emp => {
                if (emp.Department == null) Console.WriteLine($"{emp.Id}. {emp.FirstName} {emp.LastName}");
                else Console.WriteLine($"{emp.Id}. {emp.FirstName} {emp.LastName}. Dept: {emp.Department.DeptName}");
            });
